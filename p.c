...
int main(){//Start of main body function
	float raduisOfCircle=7Declaring variable of float data type
	float sideOfSquare=9;//Declaring variable of float data type
	float lengthOfRectangle=5;//Declaring variable of float data type
